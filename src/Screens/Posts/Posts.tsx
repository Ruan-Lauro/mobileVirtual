  ...
  return (
    <View style={styles.allPosts}>
        ...
        {postDo?(
            <>
                {user?.isAdmin == true?(
                    <DoPosts memberId={user?.id!} muralId={muralChoose?.id!} exit={exitDoPost} img={muralGroup!.imgGroup} category={muralChoose?.category!} groupId={muralGroup?.id!} userId={user.id!} nameMural={muralChoose?.name!} nameGroup={muralGroup?.name!} nameUser={muralGroup?.name!}/>
                ):(
                    <DoPosts memberId={user?.id!} muralId={muralChoose?.id!} exit={exitDoPost} img={user?.profile_image} category={muralChoose?.category!} groupId={muralGroup?.id!} userId={user?.id!} nameMural={muralChoose?.name!} nameGroup={muralGroup?.name!} nameUser={user?.name!}/>
                )}
            </>
        ):null}
        {loading?(
